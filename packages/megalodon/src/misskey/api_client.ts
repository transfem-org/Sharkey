  ...
  export namespace Converter {
    ...
    export const user = (u: Entity.User, host: string | null = null): MegalodonEntity.Account => {
      ...
      return {
        ...
        header: u.bannerUrl ? u.bannerUrl : 'https://dev.joinsharkey.org/static-assets/user-unknown.png',
        header_static: u.bannerUrl ? u.bannerUrl : 'https://dev.joinsharkey.org/static-assets/user-unknown.png',
